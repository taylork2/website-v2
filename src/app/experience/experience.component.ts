...
export class ExperienceComponent implements OnInit {
  experiences = [
    ...
    },
    {
      ...
      image:
        "https://www.trlm.com/wp-content/uploads/2017/09/Market-App-3-Replay-Trading-Sequences-2.gif",
      skills: ["Javascript", "WebGL", "HTML/CSS", "JIRA", "TortoiseSVN"],
      date: "JUN 2016 - APR 2017",
      desc: [
        "Collaborated with a team to create a web app to display trading data in graphical and intuitive manner using WebGL, HTML5 canvas, and JS.",
    ...
    },
    {
      ...
      image:
        "https://www.vandelaydesign.com/wp-content/uploads/01-forbes-adblock-whitelist.jpg",
      skills: ["Java", "Google Tag Manager", "SpringMVC", "Git", "Phabricator"],
      date: "JUN 2015 - AUG 2015",
      desc: [
        "Analyzed Adblock development trends and contributed to creation of “adblock blocker” which increased company revenue.",
